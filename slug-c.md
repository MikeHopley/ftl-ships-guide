...
Rushing shields gives you more opportunities for safe crew kills. Mind control can often get the job done by itself (with lasers to finish them off). Otherwise hack oxygen. You can de-power the Chain Laser to fire a single shot, and it will often keep its chain progress if you pause precisely enough.
...
Early-game tactics are slightly different depending on enemy crew count. Against two crew, consider [mind controlling the engines crew](https://www.youtube.com/watch?v=-0ERmcgqeKY) instead of the pilot when you fire the Chain Laser. But against three crew, usually mind control the weapons crew instead: this guarantees one point of system damage at 12.5 seconds.
